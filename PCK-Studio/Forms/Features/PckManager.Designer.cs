...
namespace PckStudio.Forms.Features
{
    partial class PckManager
    {
        ...
        {
			Label consoleTypeLabel;
			Label platformTypeLabel;
			...
			this.supportedPlatformComboBox = new ComboBox();
			this.mainPanel = new TableLayoutPanel();
			consoleTypeLabel = new Label();
			platformTypeLabel = new Label();
			...
			platformTypeLabel.Dock = DockStyle.Fill;
			...
			// 
			this.supportedPlatformComboBox.Dock = DockStyle.Fill;
			...
			this.mainPanel.ColumnStyles.Add(new ColumnStyle(System.Windows.Forms.SizeType.Percent, 50F));
			this.mainPanel.ColumnStyles.Add(new ColumnStyle(System.Windows.Forms.SizeType.Percent, 50F));
			...
			this.mainPanel.RowStyles.Add(new RowStyle(System.Windows.Forms.SizeType.Absolute, 35F));
			this.mainPanel.RowStyles.Add(new RowStyle());
			this.mainPanel.RowStyles.Add(new RowStyle(System.Windows.Forms.SizeType.Absolute, 20F));
